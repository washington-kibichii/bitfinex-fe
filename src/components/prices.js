...
const Prices = ({ prices }) => {
  return (
    <div>
      ...
      {prices.map((prices) => (
        <div className="card" key="{prices.key}{prices.timestamp}">
          <div className="card-body">
            ...
            <h6 className="card-subtitle mb-2 text-muted">Time: <ReactTimeAgo date={new Date(prices.timestamp).toLocaleString('en-US', { timeZone: 'Africa/Nairobi' })}/></h6>
